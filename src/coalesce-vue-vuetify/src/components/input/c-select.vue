...
export default defineComponent({
  ...
  props: {
    ...
    create: { required: false, type: Object as PropType<{
  ...
  data() {
    return {
      ...
      listCaller: null! as ListApiState<[], Model<ModelType>> & (() => ListResultPromise<Model<ModelType>>),
       ...
       */
      getCaller: null! as ItemApiStateWithArgs<[], {id: any}, Model<ModelType>>
    }
  },
  ...
  methods: {
    ...
    focus() {
        // TODO: Probably doesnt work in vue3
  ...
  created() {
    ...
    this.$watch(
      ...
      (v: boolean) => { if (v && this.reloadOnOpen) this.listCaller() }
    );
  }
})
